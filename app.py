...
eva_invoices_page = st.Page("app_pages/eva_invoices.py", title="Eva's Invoices", icon="🧾")

nav = st.navigation([home_page, register_page, invoices_page, eva_invoices_page])
nav.run()
